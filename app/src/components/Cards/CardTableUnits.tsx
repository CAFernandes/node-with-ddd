...
export default function CardTableUnits({
  color = "dark",
  title,
  columns,
  data,
                ...
                data.map((row, index) => (
                  <tr key={index}>
                    ...
                    <td className={
                          ...
                          <i className="fas fa-eye text-green-500 mr-2 cursor-pointer"></i>
                          <i className="fas fa-edit text-blue-500 mr-2 cursor-pointer"></i>
                          <i className="fas fa-trash text-red-500 mr-2 cursor-pointer"></i>
                        </td>
                  </tr>
                ))}
            </tbody>
